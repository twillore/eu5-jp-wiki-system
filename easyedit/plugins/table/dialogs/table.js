    ...
    return {
      ...
      onOk: function () {
        var d = a.getSelection(),
          ...
          c = {};
        // PukiWikiのCSSに合わせる
        b.setAttribute("class", "style_table");
        // ----
        ...
        if (c.info) {
          ...
          if (!this._.selectedElement)
            for (var h = b.append(p("tbody")), f = parseInt(c.txtRows, 10) || 0, l = parseInt(c.txtCols, 10) || 0, k = 0; k < f; k++)
              ...
              // PukiWikiのCSSに合わせる
              {
              	...
              	var b2 = p("td");
              	b2.setAttribute("class", "style_td");
          		g.append(b2).appendBogus();
              }
              // ----
          f = c.selHeaders;
          if (!b.$.tHead && ("row" == f || "both" == f)) {
            ...
            // PukiWikiのCSSに合わせる
	        for (k = 0; k < l.getChildCount(); k++) h = l.getChild(k), h.type != CKEDITOR.NODE_ELEMENT || h.data("cke-bookmark") || (h.renameNode("th"), h.setAttribute("scope", "col"), h.setAttribute("class", "style_th"));
	        // ----
            g.append(l.remove())
          }
